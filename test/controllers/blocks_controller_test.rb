...
class BlocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create block" do
    assert_difference('Block.count') do
      post blocks_url, params: { block: { content: @block.content, gauge_id: @block.gauge_id, name: @block.name } }
    end
  ...
  test "should update block" do
    patch block_url(@block), params: { block: { content: @block.content, gauge_id: @block.gauge_id, name: @block.name } }
