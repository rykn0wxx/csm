...
class DashboardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dashboard" do
    assert_difference('Dashboard.count') do
      post dashboards_url, params: { dashboard: { client_id: @dashboard.client_id, name: @dashboard.name, published: @dashboard.published } }
    end
  ...
  test "should update dashboard" do
    patch dashboard_url(@dashboard), params: { dashboard: { client_id: @dashboard.client_id, name: @dashboard.name, published: @dashboard.published } }
